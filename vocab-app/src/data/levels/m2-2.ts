...
export const M2_2 = defineLevel('m2-2', [
  ...
  { w: 'thirsty', p: 'adj.', s: [
    { m: '목마른', syn: [], ex: [
      ['I am thirsty. May I have water?', '목이 말라요. 물 좀 주시겠어요?'],
  ...
  { w: 'tooth', p: 'n.', s: [
    { m: '이, 치아', syn: [], ex: [
      ['The dentist looked at my tooth.', '치과 의사가 내 이를 살펴보았다.'],
