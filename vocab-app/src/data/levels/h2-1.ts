...
export const H2_1 = defineLevel('h2-1', [
  ...
  { w: 'administer', p: 'v.', s: [
    { m: '관리하다, 집행하다', syn: ['manage'], ex: [
      ...
      ['The city administers the public parks.', '시가 공공 공원을 관리한다.'],
  ...
  { w: 'aggress', p: 'v.', s: [
    { m: '공격하다, 시비를 걸다 (드물게 쓰는 말)', syn: ['attack'], ex: [
      ['Do not aggress against others.', '남에게 시비를 걸지 마라.'],
      ['Some animals aggress toward strangers.', '어떤 동물은 낯선 사람에게 공격적으로 군다.'],
  ...
  { w: 'alien', p: 'n.', s: [
    { m: '외계인, 외국인', syn: [], ex: [
      ...
      ['Aliens must register at the office.', '외국인은 사무소에 등록해야 한다.'],
    ]},
  ]},
  { w: 'align', p: 'v.', s: [
  ...
  { w: 'anchor', p: 'n.', s: [
    { m: '닻', syn: [], ex: [
      ...
      ['They pulled up the anchor at dawn.', '그들은 새벽에 닻을 올렸다.'],
    ]},
  ]},
  { w: 'ancient', p: 'adj.', s: [
    { m: '고대의, 아주 오래된', syn: [], ex: [
  ...
  { w: 'beam', p: 'n.', s: [
    { m: '광선, 빔', syn: ['ray'], ex: [
      ...
      ['The beam of the flashlight was weak.', '손전등의 광선이 약했다.'],
  ...
  { w: 'betray', p: 'v.', s: [
    { m: '배신하다', syn: [], ex: [
      ...
      ['He betrayed his country for money.', '그는 돈 때문에 조국을 배신했다.'],
    ]},
  ]},
  { w: 'bias', p: 'n.', s: [
    { m: '편견, 편향', syn: ['prejudice'], ex: [
  ...
  { w: 'brute', p: 'n.', s: [
    { m: '짐승 같은 사람', syn: ['beast'], ex: [
      ...
      ['Only a brute would treat animals that way.', '짐승 같은 자만이 동물을 그렇게 대할 것이다.'],
    ]},
  ]},
  { w: 'bulk', p: 'n.', s: [
    { m: '큰 규모, 대부분', syn: [], ex: [
      ...
      ['The bulk of the package made it hard to carry.', '그 꾸러미는 부피가 커서 옮기기 힘들었다.'],
    ]},
  ]},
  { w: 'bull', p: 'n.', s: [
    { m: '황소', syn: [], ex: [
  ...
  { w: 'cancel', p: 'v.', s: [
    { m: '취소하다', syn: ['call off'], ex: [
      ['They canceled the game.', '그들은 경기를 취소했다.'],
      ['She canceled her order.', '그녀는 주문을 취소했다.'],
      ['Rain canceled our picnic.', '비가 우리 소풍을 취소시켰다.'],
    ]},
  ]},
  { w: 'cancer', p: 'n.', s: [
    { m: '암', syn: [], ex: [
  ...
  { w: 'cater', p: 'v.', s: [
    { m: '음식을 공급하다, 맞추다', syn: [], ex: [
      ['They cater large parties every weekend.', '그들은 주말마다 큰 파티에 음식을 공급한다.'],
  ...
  { w: 'chin', p: 'n.', s: [
    { m: '턱', syn: [], ex: [
      ...
      ['He hit his chin on the table.', '그는 탁자에 턱을 부딪쳤다.'],
