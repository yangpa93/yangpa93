...
export const H1_4 = defineLevel('h1-4', [
  ...
  { w: 'abound', p: 'v.', s: [
    { m: '많이 있다, 풍부하다', syn: ['be plentiful'], ex: [
  ...
  { w: 'accord', p: 'n.', s: [
    { m: '합의, 일치', syn: ['agreement'], ex: [
      ...
      ['She acted of her own accord.', '그녀는 자기 뜻대로 행동했다.'],
  ...
  { w: 'term', p: 'n.', s: [
    { m: '용어, 학기', syn: ['word'], ex: [
      ...
      ['We agreed on the terms.', '우리는 조건에 합의했다.'],
    ]},
  ]},
  { w: 'terrible', p: 'adj.', s: [
  ...
  { w: 'text', p: 'n.', s: [
    { m: '글, 본문', syn: ['writing'], ex: [
      ['Read the text carefully.', '본문을 꼼꼼히 읽어라.'],
      ['She sent me a text.', '그녀가 나에게 문자를 보냈다.'],
      ['The text is too long.', '그 글은 너무 길다.'],
    ]},
  ]},
  { w: 'theater', p: 'n.', s: [
    { m: '극장', syn: ['playhouse'], ex: [
  ...
  { w: 'theatre', p: 'n.', s: [
    { m: '극장 (영국식)', syn: ['theater'], ex: [
      ...
      ['He loves theatre more than film.', '그는 영화보다 연극을 좋아한다.'],
    ]},
  ]},
  { w: 'then', p: 'adv.', s: [
    { m: '그때, 그다음에', syn: ['next'], ex: [
  ...
  { w: 'thus', p: 'adv.', s: [
    { m: '따라서, 이렇게', syn: ['therefore'], ex: [
      ...
      ['She spoke thus to the class.', '그녀는 반에 이렇게 말했다.'],
    ]},
  ]},
  { w: 'tide', p: 'n.', s: [
    { m: '조수, 흐름', syn: ['current'], ex: [
  ...
  { w: 'trade', p: 'n.', s: [
    { m: '무역, 거래', syn: ['commerce'], ex: [
      ...
      ['He learned a trade young.', '그는 어려서 기술을 배웠다.'],
  ...
  { w: 'triangle', p: 'n.', s: [
    { m: '삼각형', syn: ['three-sided figure'], ex: [
  ...
  { w: 'upper', p: 'adj.', s: [
    { m: '위쪽의, 상부의', syn: ['higher'], ex: [
      ...
      ['Her upper arm hurts.', '그녀는 윗팔이 아프다.'],
    ]},
  ]},
  { w: 'upset', p: 'adj.', s: [
    { m: '속상한, 화난', syn: ['unhappy'], ex: [
  ...
  { w: 'wheel', p: 'n.', s: [
    { m: '바퀴', syn: ['circle'], ex: [
      ...
      ['He turned the wheel slowly.', '그는 핸들을 천천히 돌렸다.'],
    ]},
  ]},
  { w: 'whether', p: 'conj.', s: [
    { m: '~인지 아닌지', syn: ['if'], ex: [
  ...
  { w: 'whistle', p: 'v.', s: [
    { m: '휘파람을 불다', syn: ['blow'], ex: [
      ['He whistled a happy song.', '그는 밝은 노래를 휘파람으로 불었다.'],
      ['The referee whistled twice.', '심판이 휘슬을 두 번 불었다.'],
  ...
  { w: 'wonder', p: 'v.', s: [
    { m: '궁금해하다', syn: ['ponder'], ex: [
      ['I wonder where she went.', '나는 그녀가 어디 갔는지 궁금하다.'],
      ['She wondered about the answer.', '그녀는 답을 궁금해했다.'],
      ['He is wondering what to do.', '그는 무엇을 할지 고민하고 있다.'],
    ]},
  ]},
  { w: 'wool', p: 'n.', s: [
    { m: '양털, 양모', syn: ['fleece'], ex: [
