...
export const M2_3 = defineLevel('m2-3', [
  ...
  { w: 'afford', p: 'v.', s: [
    { m: '여유가 되다', syn: ['be able to pay'], ex: [
  ...
  { w: 'weekend', p: 'n.', s: [
    { m: '주말', syn: ['Saturday and Sunday'], ex: [
