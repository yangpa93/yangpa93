...
const WORKS = [
  ...
  { title: '오우가', source: '윤선도, 오우가' },
  { title: '도산십이곡', source: '이황, 도산십이곡' },
  { title: '고산구곡가', source: '이이, 고산구곡가' },
  { title: '한림별곡', source: '한림별곡' },
  { title: '관서별곡', source: '백광홍, 관서별곡' },
];
