...
export const M1_1 = defineLevel('m1-1', [
  ...
  { w: 'ahead', p: 'adv.', s: [
    { m: '앞으로, 앞에', syn: ['forward'], ex: [
      ['Go ahead and start.', '먼저 시작해라.'],
  ...
  { w: 'away', p: 'adv.', s: [
    { m: '떨어져, 멀리', syn: ['off'], ex: [
      ...
      ['Put your phone away during class.', '수업 중에는 휴대폰을 치워라.'],
    ]},
  ]},
  { w: 'baby', p: 'n.', s: [
    { m: '아기', syn: ['infant'], ex: [
  ...
  { w: 'board', p: 'n.', s: [
    { m: '칠판, 판', syn: ['blackboard'], ex: [
      ...
      ['He put a photo on the board.', '그는 게시판에 사진을 붙였다.'],
    ]},
  ]},
  { w: 'boat', p: 'n.', s: [
    { m: '배, 보트', syn: ['ship'], ex: [
