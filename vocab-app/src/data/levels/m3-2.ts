...
export const M3_2 = defineLevel('m3-2', [
  ...
  { w: 'ever', p: 'adv.', s: [
    { m: '언젠가, 한 번이라도', syn: ['at any time'], ex: [
  ...
  { w: 'fault', p: 'n.', s: [
    { m: '잘못, 결점', syn: ['error'], ex: [
      ...
      ['Do not blame the fault on others.', '잘못을 남에게 돌리지 마라.'],
    ]},
  ]},
  { w: 'favor', p: 'n.', s: [
    { m: '호의, 부탁', syn: ['kindness'], ex: [
